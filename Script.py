...
class script(object):
    START_TXT = """<b>ALL MEDICAL VIDEOS AVAILABLE FREE\n
        MARROW\n
        PREPLADDER\n
        DAMS\n
        DOCTUT\n
...
# Ask Doubt on telegram @KingVJ01
    ...
    CLONE_START_TXT = """<b>PIN THIS BOT</b>\n\nDONT CLONE THE BOT AGAIN ,THIS BOT WILL BE ACTIVE FOREVER\n\nIF YOUR CLONE BOT NOT WORKING SEND THE BOTTOKEN MESSAGE OF THIS BOT TO THE NEXTPULSE BOT AGAIN.\n\nSHARE YOUR CLONE BOT TO OTHER USERS IN GROUP WHICH ARE NOT ABLE TO CLONE.\n\n<b>BELOW GIVEN STEP-3 VIDEO TUTORIAL- HOW TO WATCH LECTURES</b>"""
...
5) ꜰᴏʀᴡᴀʀᴅ ᴛʜᴀᴛ ᴍᴇssᴀɢᴇ ᴛᴏ this bot.
VIDEO TUETORIAL- <a href='https://t.me/c/2045440584/11'>Click Here</a>
</b>"""
